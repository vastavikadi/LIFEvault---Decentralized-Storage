...
const Contact = () => {
  ...
  const socialMedia = [
    {
      Icon: FaGithub,
      link: "https://github.com/vastavikadi",
      color: "#333",
    },
    {
      Icon: FaDiscord,
      link: "https://discord.com/channels/vastavikadi",
      color: "#7289DA",
    },
    {
      Icon: FaXTwitter,
      link: "https://twitter.com/vastavikadi",
      color: "#1DA1F2",
    },
    {
      Icon: FaLinkedin,
      link: "https://www.linkedin.com/in/vastavikadi",
      color: "#0077B5",
    },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setSubject("");
        setMessage("");
        setTimeout(() => setResponseMessage(""), 9000);
      } else {
  ...
  return (
    ...
    >
      <h2 className="text-5xl font-bold text-center text-blue-500 mb-2">
        Contact Us
      </h2>
      ...
      <div className="w-full max-w-5xl p-5 shadow-md rounded-lg mx-auto my-10 dark:bg-gray-200 border border-gray-300">
        <div className="p-5 dark:text-white">
          <h1
            className="text-left text-3xl md:text-4xl mb-2 text-blue-500"
            style={{
              fontSize: "2.4rem",
              fontWeight: 600,
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <div className="flex flex-col">
              <label htmlFor="name" className="formlevel">
                Name:
              </label>
              <input
                type="text"
                ...
                } rounded-md text-gray-900 dark:bg-[rgb(51,51,51)] dark:text-white`}
            ...
            <div className="flex flex-col">
              <label htmlFor="email" className="formlevel">
                Email:
              </label>
              <input
                type="email"
            ...
            <div className="flex flex-col">
              <label htmlFor="subject" className="formlevel">
                Subject:
              </label>
              <input
                id="subject"
            ...
            <div className="flex flex-col">
              <label htmlFor="message" className="formlevel">
                Message:
              </label>
              <textarea
                id="message"
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="p-2 bg-blue-600 text-white rounded-md self-start hover:bg-blue-600"
                disabled={loading}
              >
      ...
      <div className="flex flex-col items-center">
        <h3 className="text-2xl bg-blue-600 text-transparent bg-clip-text font-bold text-gray-800 mb-4">
          Our Location
        </h3>
        <p>VGU, JAIPUR, RAJASTHAN</p>
        <div className="h-64 w-full mt-4 max-w-md">
          <iframe
